...
export const AULAS_ARCA = [
  ...
  { n: 2, titulo: "A obediência me protege", texto: "Quem entrou na arca ficou seguro. Ouvir Deus, os pais e o professor é lugar de cuidado.", licao: "Obedecer protege.", verso: "E o Senhor fechou a porta.", ref: "Gênesis 7:16", img: "/arca-de-noe/quadro-40dias.webp" },
...
// "Tres faixas, uma historia": o momento em que o professor explica o que e obediencia,
...
export const FAQ = [
  { q: "O que exatamente vem no Plano Anual?", a: "Doze histórias bíblicas, uma por mês, com o material completo de Kids (4 a 6 anos) e Júnior (7 a 10 anos): apostila do professor com todos os estudos, atividades, quadro de história, versículos, lembrancinha e carta pra família. E, de bônus, o material Baby (1 a 3 anos) das mesmas doze histórias." },
